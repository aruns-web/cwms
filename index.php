...
$sql="INSERT INTO tblcarwashbooking(bookingId,packageType,fullName,mobileNumber,email,vno,model,washDate,washTime,message,status) VALUES(:bno,:ptype,:fname,:mobile,:mail,:vehicleno,:vmodel,:date,:time,:message,:status)";
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            <p>
                            360 AutoSpa is a brand that is literally going to change the way people think about car cleaning.
                             It is a unique mechanized car cleaning concept where cars are getting pampered by the latest equipments 
                            including high pressure cleaning machines, spray injection and extraction machines, high powered vacuum cleaners, steam cleaners and so on. 
                            </p>
                            <ul>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING </option>
